...
<html lang="en">
<head>
    <title>Code coverage report for src/MainHTTPSource.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">src/</a> MainHTTPSource.ts
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-yes">33×</span>
<span class="cline-any cline-yes">1×</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import {Stream, MemoryStream} from 'xstream';
...
export class MainHTTPSource implements HTTPSource {
  constructor(
    ...
    private <span class="missing-if-branch" title="if path not taken" >I</span>_namespace: Array&lt;string&gt; = []
  ) {}
&nbsp;
  public filter(
    ...
    return new MainHTTPSource(
      filteredResponse$$,
      this._name,
      scope === undefined ? <span class="branch-0 cbranch-no" title="branch not covered" >this._namespace </span>: this._namespace.concat(scope)
    );
  }
&nbsp;
